...
Tuesday ranking run. Editorial Desk verifies each image checksum, copies the
assets into the flagship publication package, attaches them to the research
email, and tells the downstream publisher to place them unchanged rather than
redrawing them. A missing or stale current-week ranking handoff or missing
ranking graphic keeps flagship research incomplete.
